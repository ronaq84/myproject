...
<head>
  ...
  <title><?php echo $__env->yieldContent('title'); ?> | The R Studio</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
    <div class="container-fluid">
      <a href="<?php echo e(url('/')); ?>" class="navbar-brand">The R Studio</a>
      ...
      <div class="collapse navbar-collapse justify-content-end text-lg-end text-start" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item"><a class="nav-link" href="<?php echo e(url('/products')); ?>">Products</a></li>
          <li class="nav-item"><a class="nav-link" href="<?php echo e(route('cart.show')); ?>">Cart</a></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  <footer>
    &copy; <?php echo e(date('Y')); ?> The R Studio | Designed with ❤️ by Ronaq
  </footer>
...
<?php /**PATH D:\Project 1\scd-project\resources\views/layouts/app.blade.php ENDPATH**/ ?>
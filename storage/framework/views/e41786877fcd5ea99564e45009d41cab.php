  ...
  <div class="container">
    ...
    <div class="row justify-content-center align-items-start gy-5">
      ...
      <div class="col-12 col-md-6">
        <form class="contact-form" id="contactForm" method="POST" action="<?php echo e(route('contact.submit')); ?>">
          <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project 1\scd-project\resources\views/contact.blade.php ENDPATH**/ ?>
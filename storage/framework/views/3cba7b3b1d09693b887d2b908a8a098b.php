...
.hero {
  position: relative;
  height: 90vh;
  background: url('<?php echo e(asset('images/hero-wedding.jpg')); ?>') center/cover no-repeat;
  display: flex;
...
.about {
  position: relative;
  background: url('<?php echo e(asset('images/about-bg.jpg')); ?>') center/cover fixed no-repeat;
  text-align: center;
}
.about::before {
  content: "";
...
.portfolio {
  position: relative;
  background: url('<?php echo e(asset('images/portfolio-bg.jpg')); ?>') center/cover fixed no-repeat;
  text-align: center;
  padding: 80px 0;
}
...
.why-us {
  position: relative;
  background: url('<?php echo e(asset('images/whyus-bg.jpg')); ?>') center/cover fixed no-repeat;
  text-align: center;
}
.why-us::before {
  content: "";
...
.packages {
  position: relative;
  background: url('<?php echo e(asset('images/package-bg.jpg')); ?>') center/cover fixed no-repeat;
  text-align: center;
  padding: 90px 5%;
}
.packages::before {
...
<section class="portfolio" id="portfolio">
  ...
  <div class="portfolio-category">
    <h3>Weddings</h3>
    <div class="gallery">
      <img src="<?php echo e(asset('images/wedding1.jpg')); ?>" alt="wedding">
      <img src="<?php echo e(asset('images/wedding2.jpg')); ?>" alt="wedding">
      <img src="<?php echo e(asset('images/wedding3.jpg')); ?>" alt="wedding">
      <img src="<?php echo e(asset('images/wedding4.jpg')); ?>" alt="wedding">
      <img src="<?php echo e(asset('images/wedding5.jpg')); ?>" alt="wedding">
      <img src="<?php echo e(asset('images/wedding6.jpg')); ?>" alt="wedding">
    </div>
  </div>
  ...
  <div class="portfolio-category">
    <h3>Photoshoots</h3>
    <div class="gallery">
      <img src="<?php echo e(asset('images/photo/photoshoot1.jpg')); ?>" alt="photoshoot">
      <img src="<?php echo e(asset('images/photo/photoshoot2.jpg')); ?>" alt="photoshoot">
      <img src="<?php echo e(asset('images/photo/photoshoot3.jpg')); ?>" alt="photoshoot">
      <img src="<?php echo e(asset('images/photo/photoshoot4.jpg')); ?>" alt="photoshoot">
      <img src="<?php echo e(asset('images/photo/photoshoot5.jpg')); ?>" alt="photoshoot">
      <img src="<?php echo e(asset('images/photo/photoshoot6.jpg')); ?>" alt="photoshoot">
    </div>
  </div>
  ...
  <div class="portfolio-category">
    ...
    <div class="gallery">
      <img src="<?php echo e(asset('images/party1.jpg')); ?>" alt="party">
      <img src="<?php echo e(asset('images/party2.jpg')); ?>" alt="party">
      <img src="<?php echo e(asset('images/party3.jpg')); ?>" alt="party">
      <img src="<?php echo e(asset('images/party4.jpg')); ?>" alt="party">
      <img src="<?php echo e(asset('images/party5.jpg')); ?>" alt="party">
      <img src="<?php echo e(asset('images/party6.jpg')); ?>" alt="party">
    </div>
  </div>
</section>
...
<section class="packages">
  ...
  <div class="package-grid">
    <div class="package-box">
      ...
      <a href="<?php echo e(url('/contact')); ?>" class="book-btn">Book Now</a>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Project 1\scd-project\resources\views/home.blade.php ENDPATH**/ ?>